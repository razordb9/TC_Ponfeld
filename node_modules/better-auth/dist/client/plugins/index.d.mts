import { i as BetterAuthPlugin$1, r as BetterAuthOptions$1, tn as SessionQueryParams, wn as InferAdditionalFieldsFromPluginOptions } from "../../index-BzgT8cQd.mjs";
...
import { a as Role, i as AccessControl, o as Statements } from "../../index-B45xbAn7.mjs";
import { B as OrganizationOptions, C as Organization, D as Team, T as OrganizationRole, _ as InferTeam, c as OrganizationPlugin, f as InferInvitation, ht as admin, k as TeamMember, m as InferOrganization, p as InferMember, pt as apiKey, tt as oidcProvider, v as Invitation, x as Member } from "../../index-BLP8lbCx.mjs";
import { t as anonymous } from "../../index-NYwYi8xD.mjs";
import "../../index-74T5_IsI.mjs";
import "../../index-PViBvM0U.mjs";
import "../../index-DVrXtIqH.mjs";
import { n as deviceAuthorization } from "../../index-eghn_0Yh.mjs";
import { n as emailOTP } from "../../index-C7v0AYqh.mjs";
import { r as genericOAuth } from "../../index-DflwMIEg.mjs";
import "../../index-ClMi8Sht.mjs";
import { t as jwt } from "../../index-1ni_0_8A.mjs";
import { n as magicLink } from "../../index-hjj802-A.mjs";
import { t as multiSession } from "../../index-cYOD8ePR.mjs";
import "../../index-DNvaBD-J.mjs";
import "../../index-CXkIWFzZ.mjs";
import { t as oneTimeToken } from "../../index-CVhQCf8K.mjs";
import "../../index-BGVqvXfP.mjs";
import { t as phoneNumber } from "../../index-CfImj7fH.mjs";
import { n as siwe } from "../../index-BLJzuqKN.mjs";
import { n as twoFactorClient } from "../../index-kmJy6lr-.mjs";
import { n as username } from "../../index-BGHbvBl4.mjs";
...
import * as _better_fetch_fetch118 from "@better-fetch/fetch";
...
declare const inferAdditionalFields: <T$1, S$1 extends {
  ...
  $InferServerPlugin: ((T$1 extends BetterAuthOptions$1 ? T$1 : T$1 extends {
  ...
  } : never : (T$1 extends BetterAuthOptions$1 ? T$1 : T$1 extends {
    options: BetterAuthOptions$1;
  } ? T$1["options"] : never) extends BetterAuthOptions$1 ? {
    id: "additional-fields";
    schema: {
      user: {
        fields: (T$1 extends BetterAuthOptions$1 ? T$1 : T$1 extends {
          options: BetterAuthOptions$1;
  ...
  } : never) extends BetterAuthPlugin$1 ? (T$1 extends BetterAuthOptions$1 ? T$1 : T$1 extends {
    options: BetterAuthOptions$1;
  } ? T$1["options"] : never) extends never ? S$1 extends {
    user?: {
      [key: string]: DBFieldAttribute;
...
declare const oneTapClient: (options: GoogleOneTapOptions) => {
  id: "one-tap";
  getActions: ($fetch: _better_fetch_fetch118.BetterFetch, _: _better_auth_core23.ClientStore) => {
...
declare const organizationClient: <CO extends OrganizationClientOptions>(options?: CO | undefined) => {
  ...
  getActions: ($fetch: _better_fetch_fetch118.BetterFetch, _$store: _better_auth_core23.ClientStore, co: _better_auth_core23.BetterAuthClientOptions | undefined) => {
    $Infer: {
  ...
  getAtoms: ($fetch: _better_fetch_fetch118.BetterFetch) => {
    ...
    activeOrganization: nanostores6.PreinitializedWritableAtom<{
      ...
      error: null | _better_fetch_fetch118.BetterFetchError;
      isPending: boolean;
...
} | undefined ? S_1 : undefined : undefined : undefined : S$1;
//#endregion
