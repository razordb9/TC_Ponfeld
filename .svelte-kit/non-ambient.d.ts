...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/AGB" | "/Blog" | "/Impressum" | "/Scroller" | "/admin" | "/admin/design" | "/admin/posts" | "/admin/posts/create" | "/admin/posts/[slug]" | "/admin/posts/[slug]/edit" | "/admin/users" | "/admin/users/create" | "/auth" | "/auth/forgotpassword" | "/auth/login";
		RouteParams(): {
